...
class DiscoveryPublishServiceTest {

    @Test
    void publishReadyRows_processesOnlyDiscoveryRows() {
        GoogleSheetsService sheetsService = mock(GoogleSheetsService.class);
        DiscoveryPublishService service = new DiscoveryPublishService(
                sheetsService,
                mock(DiscoveryDeduplicationService.class),
        ...
        assertThat(captor.getValue().rowNumber()).isEqualTo(218);
    }

    @Test
    void publishReadyRows_mapsEnumsAndStoresSixResolvedTags() {
        GoogleSheetsService sheetsService = mock(GoogleSheetsService.class);
        DiscoveryDeduplicationService deduplicationService = mock(DiscoveryDeduplicationService.class);
        ...
        DiscoverySheetRowDto row = publishableRow(218, "DISCOVERY");
        ...
        assertThat(requestCaptor.getValue().sourceType()).isEqualTo(SourceType.DISCOVERY);
