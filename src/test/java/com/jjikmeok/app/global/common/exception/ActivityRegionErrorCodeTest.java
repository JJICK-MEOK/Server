...
class ActivityRegionErrorCodeTest {
    ...
    private static Stream<Arguments> activityRegionErrorCodes() {
        return Stream.of(
                ...
                Arguments.of(ErrorCode.ACTIVITY_SYNC_CONFIG_MISSING, HttpStatus.BAD_REQUEST, "ACTIVITY_SYNC_400_CONFIG"),
                Arguments.of(ErrorCode.ACTIVITY_SYNC_INVALID_URL, HttpStatus.BAD_REQUEST, "ACTIVITY_SYNC_400_URL"),
                Arguments.of(ErrorCode.ACTIVITY_SYNC_EXTERNAL_FAILED, HttpStatus.BAD_GATEWAY, "ACTIVITY_SYNC_502_EXTERNAL"),
                Arguments.of(ErrorCode.ACTIVITY_SYNC_UNSUPPORTED_SOURCE, HttpStatus.BAD_REQUEST, "ACTIVITY_SYNC_400_SOURCE"),
